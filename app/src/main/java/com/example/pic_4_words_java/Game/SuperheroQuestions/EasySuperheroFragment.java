package com.example.pic_4_words_java.Game.SuperheroQuestions;
...
import com.example.pic_4_words_java.Game.DifficultyFragment;
import com.example.pic_4_words_java.R;
import com.google.android.material.floatingactionbutton.FloatingActionButton;

public class EasySuperheroFragment extends Fragment {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_easy_superhero, container, false);
